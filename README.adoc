 ...
 ** 2025-02-08: Added turnrate implementation and modified the
    the default scenario to make use of that. This makes the simulation
    scenario more intesting when running for a longer time.
